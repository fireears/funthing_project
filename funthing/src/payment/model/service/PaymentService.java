...
//
//    public ArrayList<Product> pNoSearch(ArrayList<Product> productList) {
//		Connection conn = getConnection();
//		
//		ArrayList<Product> pNoList = new ArrayList<>();
//		pNoList = new PaymentDao().pNoSearch(conn, productList);
//		
//		close(conn);
//		return pNoList;
//	}
