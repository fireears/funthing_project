...
/**
 * Servlet implementation class MemberReviewSelect
 */
@WebServlet("/MemberReviewSelect")
public class MemberReviewSelect extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberReviewSelect() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try
		{
		    ...
		    int listCount = ls.reviewCount(Search,mNo);
		    limit = 10;
			...
			ArrayList<MemberReview> list = ls.reviewSelectList(Search,currentPage,limit,mNo);
