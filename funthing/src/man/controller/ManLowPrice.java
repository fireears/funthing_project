...
/**
 * Servlet implementation class ManLowPrice
 */
@WebServlet("/ManLowPrice")
public class ManLowPrice extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			list = ms.selectListHighPrice(currentPage, limit);	
