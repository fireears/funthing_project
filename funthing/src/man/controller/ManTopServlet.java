...
/**
 * Servlet implementation class ManTopServlet
 */
@WebServlet("/ManTopServlet")
public class ManTopServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManTopServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int listCount = ms.ManTopListCount();
			...
			list = ms.selectListTop(currentPage, limit);	
