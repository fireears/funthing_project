...
/**
 * Servlet implementation class ManJeanServlet
 */
@WebServlet("/ManJeanServlet")
public class ManJeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManJeanServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int listCount = ms.ManJeanListCount();
			...
			list = ms.selectListJean(currentPage, limit);	
