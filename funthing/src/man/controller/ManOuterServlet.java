...
/**
 * Servlet implementation class ManOuterServlet
 */
@WebServlet("/ManOuterServlet")
public class ManOuterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManOuterServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int listCount = ms.ManOuterListCount();
			...
			list = ms.selectListOuter(currentPage, limit);	
