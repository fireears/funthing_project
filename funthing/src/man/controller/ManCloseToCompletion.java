...
/**
 * Servlet implementation class ManCloseToCompletion
 */
@WebServlet("/ManCloseToCompletion")
public class ManCloseToCompletion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManCloseToCompletion() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			list = ms.selectListCloseToCompletion(currentPage, limit);	
