...
/**
 * Servlet implementation class WomenNewProduct
 */
@WebServlet("/WomenNewProduct")
public class WomenNewProduct extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WomenNewProduct() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			list = ws.selectListNewProduct(currentPage, limit);	
