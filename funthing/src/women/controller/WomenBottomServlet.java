...
/**
 * Servlet implementation class WomenBottomServlet
 */
@WebServlet("/WomenBottomServlet")
public class WomenBottomServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WomenBottomServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int listCount = ws.WomenBottomListCount();
			...
			list = ws.selectListBottom(currentPage, limit);	
