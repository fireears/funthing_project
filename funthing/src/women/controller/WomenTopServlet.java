...
/**
 * Servlet implementation class WomenTopServlet
 */
@WebServlet("/WomenTopServlet")
public class WomenTopServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WomenTopServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int listCount = ws.WomenTopListCount();
			...
			list = ws.selectListTop(currentPage, limit);	
