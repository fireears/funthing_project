...
/**
 * Servlet implementation class WomenCloseToCompletion
 */
@WebServlet("/WomenCloseToCompletion")
public class WomenCloseToCompletion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WomenCloseToCompletion() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			list = ws.selectListCloseToCompletion(currentPage, limit);	
