...
/**
 * Servlet implementation class WomenHighPrice
 */
@WebServlet("/WomenHighPrice")
public class WomenHighPrice extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WomenHighPrice() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			list = ws.selectListHighPrice(currentPage, limit);	
