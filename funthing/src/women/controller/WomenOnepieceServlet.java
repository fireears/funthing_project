...
/**
 * Servlet implementation class WomenOnepieceServlet
 */
@WebServlet("/WomenOnepieceServlet")
public class WomenOnepieceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WomenOnepieceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int listCount = ws.WomenOnepieceListCount();
			...
			list = ws.selectListOnepiece(currentPage, limit);	
