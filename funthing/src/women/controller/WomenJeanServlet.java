...
/**
 * Servlet implementation class WomenJeanServlet
 */
@WebServlet("/WomenJeanServlet")
public class WomenJeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WomenJeanServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int listCount = ws.WomenJeanListCount();
			...
			list = ws.selectListJean(currentPage, limit);	
