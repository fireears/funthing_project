...
/**
 * Servlet implementation class WomenOuterServlet
 */
@WebServlet("/WomenOuterServlet")
public class WomenOuterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WomenOuterServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int listCount = ws.WomenOuterListCount();
			...
			list = ws.selectListOuter(currentPage, limit);	
