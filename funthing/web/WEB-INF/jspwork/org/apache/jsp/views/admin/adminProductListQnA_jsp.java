...
<<<<<<< HEAD
 * Generated at: 2020-05-21 04:31:06 UTC
=======
<<<<<<< HEAD
 * Generated at: 2020-05-20 15:36:29 UTC
=======
 * Generated at: 2020-05-20 15:23:51 UTC
...
public final class adminProductListQnA_jsp extends org.apache.jasper.runtime.HttpJspBase
...
=======
<<<<<<< HEAD
    _jspx_dependants.put("/views/admin/../common/adminHeader.jsp", Long.valueOf(1589988508059L));
=======
...
>>>>>>> refs/remotes/origin/master
  ...
  static {
    ...
    _jspx_imports_classes.add("productQnA.model.vo.ProductQnAReply");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>product QnA</title>\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/admin/productQnA\" method=\"GET\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<option value=\"p_No2\">상품번호</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"RE_YN\">답변여부</option>\r\n");
      out.write("\t\t\t\t\t     </select>\r\n");
      out.write("\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t<span> \r\n");
...
if(searchKind != null && searchText != null){ 
 ...
 if(!list.isEmpty()){ 
      ...
      out.write("                <tr>\r\n");
      out.write("\t                <th>번호</th> <th>아이디</th> <th>상품번호</th> <th>상품명</th> <th>내용</th> <th>작성날짜</th>  <th>답변여부</th>  \r\n");
      out.write("                </tr>\r\n");
      out.write("                \r\n");
      out.write("\t            ");
for(AdminProductQnA pq : list) {
      ...
      out.write("</td> <td>");
      out.print(pq.getReYn());
      out.write("</td> \r\n");
      out.write("\t            </tr>\r\n");
      out.write("\t            <tr class=\"cont\">\r\n");
      out.write("\t            \t<td colspan=\"7\">\r\n");
      out.write("\t            \t<div id=\"contDiv\">\r\n");
      out.write("\t            \t\t<span class=\"info\">번호 : </span><span>");
      out.print(pq.getQnaNo() );
      ...
      out.print(pq.getpName() );
      out.write("</span><br><br>\r\n");
      out.write("\t            \t\t<span class=\"info\">제목 : </span><span>");
      out.print(pq.getQnaTitle() );
      out.write("</span><br><br>\r\n");
      out.write("\t            \t\t<span class=\"info\">내용 : </span><span>");
      out.print(pq.getQnaContents() );
      out.write("</span><br><br>\r\n");
      out.write("\t            \t\t<span class=\"info\">작성날짜 : </span><span>");
      out.print(pq.getQnaDate() );
      out.write("</span><br><br>\r\n");
      out.write("\t           \t\r\n");
      out.write("\t            \t\t <!-- 댓글 -->\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/admin/productQnaRe\" method=\"post\">\r\n");
      out.write("\t            \t\t\t<table align=\"center\" id=\"replyTable\">\r\n");
      out.write("\t            \t\t\t\t<tr>\r\n");
      out.write("\t            \t\t\t\t\t\r\n");
      out.write("\t            \t\t\t\t\t<input type=\"hidden\" name=\"proQnaNo\" value=\"");
      out.print(pq.getQnaNo() );
      out.write("\">\r\n");
      ...
      out.write("                \t<td colspan=\"7\"><div style=\"text-align:center\">검색 결과가 없습니다. 다시 검색해주세요.</div></td>\r\n");
      out.write("                </tr>\t\r\n");
      out.write("                  ");
} 
      out.write("\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/admin/productQnA?currentPage=");
      out.print(1 );
      out.write("&searchText='+$(\"#searchText\").val()\"&searchKind=\"$(\"#searchKind).val()\"> << </button>\r\n");
      out.write("\t        \t");
if(currentPage == 1) { 
      out.write("\r\n");
...
for(int p = startPage; p<=endPage; p++) { 
	...
	if(p == currentPage) { 
      ...
      out.write("/admin/productQnA?currentPage=");
      out.print(p);
      out.write("&search='+$(\"#searchText\").val()\"&searchKind=\"+$(\"#searchKind).val()\">");
      out.print(p );
      out.write("</button>\r\n");
      out.write("\t        \t\r\n");
      out.write("\t        \t");
...
if(currentPage == maxPage) {
      ...
      out.write("<!-- searchKind == null && searchText == null -->\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t");
 if(!list.isEmpty()){ 
      out.write("\r\n");
...
for(AdminProductQnA pq : list) {
      ...
      out.print(pq.getQnaNo() );
      out.write("</span><br><br>\r\n");
      out.write("\t            \t\t<span class=\"info\">회원번호 : </span><span>");
      out.print(pq.getmId() );
      out.write("</span><br><br>\r\n");
      out.write("\t            \t\t<span class=\"info\">회원아이디 : </span><span>");
      out.print(pq.getpNo() );
      ...
      out.write("\t            \t\t\t<table align=\"center\" id=\"replyTable\">\r\n");
      out.write("\t            \t\t\t\t<tr>\r\n");
      out.write("\t            \t\t\t\t\t<td width=220px; ><textArea rows=\"4\" cols=\"220\" id=\"replyContent\"></textArea></td>\r\n");
      out.write("\t            \t\t\t\t\t<td><button id=\"seachBtn\">답변등록</button></td>\r\n");
      out.write("\t            \t\t\t\t</tr>\r\n");
      out.write("\t            \t\t\t</table>\r\n");
      out.write("\t            \t\r\n");
      out.write("\t            \t\t");
...
for(int p = startPage; p<=endPage; p++) { 
	...
	if(p == currentPage) { 
      ...
      out.write("/admin/productQnA?currentPage=");
      out.print(p);
      out.write("&searchText='+$(\"#searchText\").val()\"&searchKind=\"+$(\"#searchKind).val()\">");
      out.print(p );
      out.write("</button>\r\n");
      out.write("\t        \t\r\n");
      out.write("\t        \t");
