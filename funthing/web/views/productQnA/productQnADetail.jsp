...
<%
		AdminProductQnA apq = (AdminProductQnA)request.getAttribute("apq");
        ...
        <div class="q1_title">
            ...
            <div class="q1_wrap">
                    ...
                    <table>
                     	 <tr>
                            <td>작성날짜</td>
                            <td><span><%= apq.getQnaDate() %></span></td>
                        </tr>
                  	    <tr>
                            <td>회원아이디</td>
                            <td><span><%= apq.getmId()%></span></td>
                        </tr>
                        <tr>
                            <td>이름</td>
                            <td><span><%= apq.getmName() %></span></td>
                        </tr>
                         <tr>
                            <td>상품번호</td>
                            <td><span><%= apq.getpNo()%></span></td>
                        </tr>
                        <tr>
                            <td>상품명</td>
                            <td><span><%= apq.getpName()%></span></td>
                        </tr>
                        <tr>
                            <td>제목</td>
                            <td><span><%= apq.getQnaTitle() %></span></td>
                        </tr>
                        <tr>
                            <td>내용</td>
                            <td><span>상품명 <%= apq.getQnaContents() %></span>
                        </tr>
                        <tr>
                            <td>작성자</td>
                            <td><%=apq.getmName()%></td>
                        ...
                        <tr>
                            <td>본문</td>
                            <td>
                                <span><p><%=apq.getQnaContents() %></p></span>
