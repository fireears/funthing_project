       ...
       <%@ include file="../common/adminHeader.jsp" %>
        ...
        <form method="post" action="<%=request.getContextPath()%>/admin/modifyUpdate?mNo=<%=member.getmNo()%>">
            ...
            <div id="d" style="text-align: center;">
                <input type="submit" value="수정" id="submit_btn" style="width: 90px; height: 40px; border: 0; color: white; background: darkgrey; border-radius: 7px;" onclick="insertCheck()">
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <input type="button" value="취소" id="cancel" onclick=cancle(); style="width: 90px; height: 40px; border: 0; color: black; background-color: lightgray; border-radius: 7px;">
            </div>
        </form>
